...
def _hparams(algorithm, dataset, random_state):
    ...
    if dataset not in SMALL_IMAGES:
        ...
        if dataset == "DomainNet":
            ...
            hparams["batch_size"] = (32, int(2 ** random_state.uniform(3, 5.5)))  # original 32
        if algorithm == "ARM":
    ...
    elif algorithm in ("MMD", "CORAL", "HTCL"):
        hparams["mmd_gamma"] = (1.0, 10 ** random_state.uniform(-1, 1))
        hparams["CL_weight"] = (1.0, 10 ** random_state.uniform(-1, 1))
